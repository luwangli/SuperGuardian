#ifndef _SF_BSKTHLL_H
#define _SF_BSKTHLL_H
...
public:
    SF_BSktHLL(int Mem, float ratio, float a, float b, int Unum, int Usize, int sk_depth){
        sf_alpha = a;
        sf_beta = b;
        ...
        Clear();
        SKT = new BSktHLL((int)Mem *(1-ratio), sk_unum, sk_usize,sk_depth);
    }
