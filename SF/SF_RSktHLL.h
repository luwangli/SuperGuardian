#ifndef _SF_RSKTHLL_H
#define _SF_RSKTHLL_H
...
public:
    SF_RSktHLL(int Mem, float ratio, float a, float b, int Unum, int Usize, int sk_depth){
        sf_alpha = a;
        sf_beta = b;
        ...
        Clear();
        SKT = new RSktHLL((int)Mem *(1-ratio), sk_unum, sk_usize,sk_depth);
    }
